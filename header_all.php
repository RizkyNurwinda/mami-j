                ...
                <div id="welcomeLine" class="row">
                 <div class="span6">Welcome!
                   ...
                   user
                    ...
                    <strong> <h7><?php echo $_SESSION['username']['username']; ?></h7></strong> <a href="logout.php" class="btn-danger btn-md">Logout</a>
                    <?php endif ?>
                  </div>
                   <div class="span6">
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <p class="breadcrumbs"><span class="mr-2"><a href="index.php">Semua</a></span> <span>Produk</span></p>
            <h1 class="mb-0 bread">MAMI J</h1>
          </div>
        </div>
      </div>
    </div>
