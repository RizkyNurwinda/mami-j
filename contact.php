      ...
      <div class="container">
          ...
          <div class="col-md-3 d-flex">
          	<div class="info bg-white p-4">
	            <p><span>Beri Kritikan</span> </p>
	          </div>
          </div>
          <div class="col-md-3 d-flex">
          	<div class="info bg-white p-4">
	            <p><span>Kirim Masukkan</span></p>
	          </div>
          </div>
          <div class="col-md-3 d-flex">
          	<div class="info bg-white p-4">
	            <p><span>Lapor Pengaduan</span></a></p>
	          </div>
          </div>
          <div class="col-md-3 d-flex">
          	<div class="info bg-white p-4">
	            <p><span>Saran Pengembangan</span></p>
	          </div>
          </div>
        </div>
        <div class="row block-9">
          <div class="col-md-6 order-md-last d-flex">
            <form action="./mail.php" class="bg-white p-5 contact-form" method="post">
              ...
              <div class="form-group">
                  ...
                  <!-- <a href="mail.php" class="btn btn-primary" name="submit">Send Message</a> -->
              </div>
            </form>
          ...
          <div class="col-md-6 d-flex">
          	<a href="https://www.gambaranimasi.org/cat-surat-1335.htm"><img src="https://www.gambaranimasi.org/data/media/1335/animasi-bergerak-surat-0264.gif" border="0" alt="animasi-bergerak-surat-0264"  width="400"/></a> <div class="bg-white"> </div>
          </div>
        </div>
      </div>
    </section>
