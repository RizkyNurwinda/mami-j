                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="overview-wrap">
                                    <h2 class="title-1">Tambah Pelanggan</h2>

<a href="pelanggan.php"><button  class="btn btn-primary" name=""><i class="zmdi"></i> Kembali</button></a>
</div>
</div>
</div>
...
<form method="post" enctype="multipart/form-data">
   <div class="form-group">
       ...
       <select type="text" class="form-control" name="akses">
            <?php
                        $ambil = $koneksi->query ("SELECT * FROM akses");
...
if (isset($_POST['save']))
{
    ...
    $koneksi->query("INSERT INTO user
        (akses,username,email,password,nomor)
        VALUES('1','$_POST[username]','$_POST[email]','$_POST[password]','$_POST[nomor]')");
