...
$pecah = $ambil->fetch_assoc();
 ...
 <form method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
        <label>Telepon</label>
        <input type="number" class="form-control" name="telepon" value="<?php echo $pecah['nomor']; ?>">
    </div>
...
if (isset($_POST['ubah'])) 
{
        ...
        $koneksi->query("UPDATE user SET username='$_POST[nama]',email='$_POST[email]',nomor='$_POST[telepon]' WHERE id_user='$_GET[id]'");
