	    		...
	    		<div class="col-lg-12 d-block">
		    		<div class="row d-flex">
		    			<div class="col-md pr-4 d-flex topper align-items-center">
						    ...
						    <span class="text">085895014535</span>
					    </div>
					    <div class="col-md pr-4 d-flex topper align-items-center">
					    	<div class="icon mr-2 d-flex justify-content-center align-items-center"><span class="icon-paper-plane"></span></div>
						    <span class="text">anisasaf5@gmail.com</span>
					    </div>
		...
		<div class="form-inline navbar-search">
			...
			<input class="srchTxt" style=" " type="text" name="q" placeholder="Mau Belanja Apa Hari ini?" value="<?php $q = isset($_REQUEST['q']) ? urldecode($_REQUEST['q']) : ''; echo $q ?>"/>
                                ...
                                ?>
                                 ...
                                 <a href="kategorisayuran.php"><span class="btn btn-medium btn-primary"> [ <?php if (empty($_SESSION[" "]) OR !isset($_SESSION[" "])) {
						      		echo 0;
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item active"><a href="login+daftar.php" class="nav-link">Login</a></li>
        ...
        <div class="row mb-5">
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
              <h2 class="ftco-heading-2">MAMI-J</h2>
              <p>Aneka Sayuran, susu, dan roti yang merupakan hasil produksi dari Politeknik Negeri Jember</p>
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4 ml-md-5">
              ...
              <ul class="list-unstyled">
                ...
                <li><a href="about.php" class="py-2 d-block">About Me</a></li>
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
            	<h2 class="ftco-heading-2">Butuh Info?</h2>
            	<div class="block-23 mb-3">
	              <ul>
	                <li><span class="icon icon-map-marker"></span><span class="text">Jalan Mastrip Kotak Pos 164 Jember 18121</span></li>
	                <li><a href="#"><span class="icon icon-phone"></span><span class="text">085895014535</span></a></li>
	                <li><a href="#"><span class="icon icon-envelope"></span><span class="text">anisasaf5gmail.com</span></a></li>
	              </ul>
	            </div>
            </div>
          </div>
